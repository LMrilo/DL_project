...
def parse_args():
    ...
    parser.add_argument("--repo-id", type=str, default="LMrilo/ppo-LunarLander-v2-unit8", 
    ...
    for update in range(1, num_updates + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            for idx, d in enumerate(done):
                if d:
                    print("global_step={}\tinfo={}".format(global_step, info[idx]["episode"]["r"]))
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                with torch.no_grad():
                    old_approx_kl = (-ratio + 1 - ratio.log()).mean().item()
